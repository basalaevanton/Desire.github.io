      ...
      <main class="main">
        ...
        <section class="collection">
          ...
          <div class="collection__gallery">
            <div class="collection__gallery-item">
              ...
              <div class="stages__diagramma-box">
                ...
                >
                  <img
                    ...
                    src="./img/icons/stages-graphic tool.svg"
                    alt="img"
                  />
                ...
                >
                  <img
                    class="stages__diagramma-img"
                    src="./img/icons/stages-measuring tape.svg"
                    alt="img"
                  />
            ...
            <div class="BlogMain__items">
              <div class="BlogMain__item">
                ...
                <div class="BlogMain__info">
                  <p>
                    <time pubdate datetime="2012-03-12">March 12, 2020</time>|
                    by Ann Summers | Inrerior
                  </p>
                  <a href="./blog__post.html">
              ...
              <div class="BlogMain__item">
                ...
                <div class="BlogMain__info">
                  <p>
                    <time pubdate datetime="2020-09-28">September 28,2020</time
                    >| by Finnagan Morningstar | Dining room interior
                  </p>
                  <a href="./blog__post.html">
                    <h5 class="BlogMain__item-title">
